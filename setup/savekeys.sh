...
echo alias docker-${NODE_INSTANCE}-${i}='docker --tlsverify --tlscacert="\${_cert_dir}/ca.pem" --tlscert="\${_cert_dir}/cert.pem" --tlskey="\${_cert_dir}/key.pem" -H=tcp://${node_ip}:2376'
eval alias "docker-${NODE_INSTANCE}-${i}='docker --tlsverify --tlscacert="\${_cert_dir}/ca.pem" --tlscert="\${_cert_dir}/cert.pem" --tlskey="\${_cert_dir}/key.pem" -H=tcp://${node_ip}:2376'"
